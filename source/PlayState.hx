...
class PlayState extends MusicBeatState
{
	...
	function cacheCountdown()
	{
		...
		Paths.sound(introSoundsPrefix + 'intro3');
		Paths.sound(introSoundsPrefix + 'intro2');
		Paths.sound(introSoundsPrefix + 'intro1');
		Paths.sound(introSoundsPrefix + 'introGo');
	}
	...
	public function startCountdown():Void
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000 / playbackRate, function(tmr:FlxTimer)
			{
				...
				{
					case 0:
						FlxG.sound.play(Paths.sound(introSoundsPrefix + 'intro3'), 0.6);
					case 1:
						...
						FlxG.sound.play(Paths.sound(introSoundsPrefix + 'intro2'), 0.6);
					case 2:
						...
						FlxG.sound.play(Paths.sound(introSoundsPrefix + 'intro1'), 0.6);
					case 3:
						...
						FlxG.sound.play(Paths.sound(introSoundsPrefix + 'introGo'), 0.6);
					case 4:
				}
